 ...
 */
class AssetCollection extends \Neos\Media\Domain\Model\AssetCollection implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AssetCollection $proxy) {
     ...
     * {@inheritDoc}
     */
    public function addAsset(\Neos\Media\Domain\Model\Asset $asset): bool
    {
     ...
     * {@inheritDoc}
     */
    public function removeAsset(\Neos\Media\Domain\Model\Asset $asset): bool
    {
