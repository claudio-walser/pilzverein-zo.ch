...
namespace Neos\Flow\Persistence\Doctrine\Proxies\__CG__\Neos\ContentRepository\Migration\Domain\Model;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class MigrationStatus extends \Neos\ContentRepository\Migration\Domain\Model\MigrationStatus implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MigrationStatus $proxy) {
    ...
    public function getApplicationTimeStamp()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getApplicationTimeStamp', []);
