 ...
 */
class QualityImageAdjustment extends \Neos\Media\Domain\Model\Adjustment\QualityImageAdjustment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (QualityImageAdjustment $proxy) {
