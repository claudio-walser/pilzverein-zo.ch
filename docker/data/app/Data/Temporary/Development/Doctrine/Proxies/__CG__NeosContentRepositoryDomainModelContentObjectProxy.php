 ...
 */
class ContentObjectProxy extends \Neos\ContentRepository\Domain\Model\ContentObjectProxy implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ContentObjectProxy $proxy) {
