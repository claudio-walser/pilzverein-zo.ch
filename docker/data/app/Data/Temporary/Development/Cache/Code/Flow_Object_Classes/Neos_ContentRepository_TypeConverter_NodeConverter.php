...
class NodeConverter extends NodeConverter_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\ContentRepository\TypeConverter\NodeConverter') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\ContentRepository\TypeConverter\NodeConverter', $this);
        if ('Neos\ContentRepository\TypeConverter\NodeConverter' === get_class($this)) {
...
# PathAndFilename: /var/www/html/neos/Packages/Application/Neos.ContentRepository/Classes/TypeConverter/NodeConverter.php
#