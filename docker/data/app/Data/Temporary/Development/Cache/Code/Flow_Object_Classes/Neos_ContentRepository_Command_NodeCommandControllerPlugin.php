...
class NodeCommandControllerPlugin extends NodeCommandControllerPlugin_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\ContentRepository\Command\NodeCommandControllerPlugin') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\ContentRepository\Command\NodeCommandControllerPlugin', $this);
        if ('Neos\ContentRepository\Command\NodeCommandControllerPlugin' === get_class($this)) {
...
# PathAndFilename: /var/www/html/neos/Packages/Application/Neos.ContentRepository/Classes/Command/NodeCommandControllerPlugin.php
#