 ...
 * these, it must call popContext() to reset the context to the last state.
 */
class Runtime extends Runtime_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    public function __construct()
    {
        ...
        if (!array_key_exists(1, $arguments)) $arguments[1] = \Neos\Flow\Core\Bootstrap::$staticObjectManager->get('Neos\Flow\Mvc\Controller\ControllerContext');
        ...
        if (!array_key_exists(1, $arguments)) throw new \Neos\Flow\ObjectManagement\Exception\UnresolvedDependenciesException('Missing required constructor argument $controllerContext in class ' . __CLASS__ . '. Note that constructor injection is only support for objects of scope singleton (and this is not a singleton) – for other scopes you must pass each required argument to the constructor yourself.', 1296143788);
        call_user_func_array('parent::__construct', $arguments);
        if ('Neos\Fusion\Core\Runtime' === get_class($this)) {
  ...
  'contextStack' => 'array',
  'applyValueStack' => 'array',
  'defaultContextVariables' => 'array',
  'fusionConfiguration' => 'array',
  ...
  'simpleTypeToArrayClosure' => '\\Closure',
    ...
    {
        $this->injectSettings(\Neos\Flow\Core\Bootstrap::$staticObjectManager->get(\Neos\Flow\Configuration\ConfigurationManager::class)->getConfiguration('Settings', 'Neos.Fusion'));
...
# PathAndFilename: /var/www/html/neos/Packages/Application/Neos.Fusion/Classes/Core/Runtime.php
#