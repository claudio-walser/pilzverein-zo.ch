 ...
 */
class SiteCommandController extends SiteCommandController_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\Neos\Command\SiteCommandController') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Neos\Command\SiteCommandController', $this);
        parent::__construct();
        if ('Neos\Neos\Command\SiteCommandController' === get_class($this)) {
  ...
  'output' => 'Neos\\Flow\\Cli\\ConsoleOutput',
    ...
    private function Flow_Proxy_injectProperties()
    {
        ...
        $this->Flow_Proxy_LazyPropertyInjection('Neos\Neos\Domain\Service\SiteExportService', 'Neos\Neos\Domain\Service\SiteExportService', 'siteExportService', 'bc4787b385090f9d55b32d917e916449', function() { return \Neos\Flow\Core\Bootstrap::$staticObjectManager->get('Neos\Neos\Domain\Service\SiteExportService'); });
...
# PathAndFilename: /var/www/html/neos/Packages/Application/Neos.Neos/Classes/Command/SiteCommandController.php
#