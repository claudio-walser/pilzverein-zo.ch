 ...
 * A parser which extracts cache segments by searching for start and end markers in the given content.
 */
class CacheSegmentParser extends CacheSegmentParser_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    public function __construct()
    {
        ...
        if (!array_key_exists(0, $arguments)) throw new \Neos\Flow\ObjectManagement\Exception\UnresolvedDependenciesException('Missing required constructor argument $content in class ' . __CLASS__ . '. Note that constructor injection is only support for objects of scope singleton (and this is not a singleton) – for other scopes you must pass each required argument to the constructor yourself.', 1296143788);
  ...
  'randomCacheMarkerLength' => 'integer',
  'output' => 'string',
  'outerSegmentContent' => 'string',
  'cacheSegments' => 'array',
  'uncachedPartCount' => 'integer',
  'content' => 'string',
);
...
# PathAndFilename: /var/www/html/neos/Packages/Application/Neos.Fusion/Classes/Core/Cache/CacheSegmentParser.php
#