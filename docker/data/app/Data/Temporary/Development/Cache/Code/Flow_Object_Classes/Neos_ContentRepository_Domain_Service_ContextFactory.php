 ...
 */
class ContextFactory extends ContextFactory_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    public function __construct()
    {
        ...
        if (get_class($this) === 'Neos\ContentRepository\Domain\Service\ContextFactory') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\ContentRepository\Domain\Service\ContextFactory', $this);
        if ('Neos\ContentRepository\Domain\Service\ContextFactory' === get_class($this)) {
...
# PathAndFilename: /var/www/html/neos/Packages/Application/Neos.ContentRepository/Classes/Domain/Service/ContextFactory.php
#