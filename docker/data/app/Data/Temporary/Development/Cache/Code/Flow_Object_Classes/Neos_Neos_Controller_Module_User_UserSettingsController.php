 ...
 */
class UserSettingsController_Original extends AbstractModuleController
{
    /**
     * @Flow\Inject
 ...
 */
class UserSettingsController extends UserSettingsController_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    public function __construct()
    {
        ...
        if (get_class($this) === 'Neos\Neos\Controller\Module\User\UserSettingsController') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Neos\Controller\Module\User\UserSettingsController', $this);
        if ('Neos\Neos\Controller\Module\User\UserSettingsController' === get_class($this)) {
            $this->Flow_Proxy_injectProperties();
        }

        $isSameClass = get_class($this) === 'Neos\Neos\Controller\Module\User\UserSettingsController';
        if ($isSameClass) {
    ...
    public function __wakeup()
    {
        ...
        $isClassProxy = array_search('Neos\Neos\Controller\Module\User\UserSettingsController', $classParents) !== false && array_search('Doctrine\ORM\Proxy\Proxy', $classImplements) !== false;
    ...
    public function indexAction()
    {
        ...
        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['indexAction'])) {
            ...
            try {
                ...
                $adviceChain->rewind();
                $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\Neos\Controller\Module\User\UserSettingsController', 'indexAction', $methodArguments, $adviceChain);
    ...
    public function editAction()
    {
        ...
        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['editAction'])) {
            ...
            try {
                ...
                $adviceChain = $adviceChains['Neos\Flow\Aop\Advice\AroundAdvice'];
                $adviceChain->rewind();
                $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\Neos\Controller\Module\User\UserSettingsController', 'editAction', $methodArguments, $adviceChain);
                $result = $adviceChain->proceed($joinPoint);
                $methodArguments = $joinPoint->getMethodArguments();
    ...
    public function updateAction(\Neos\Neos\Domain\Model\User $user)
    {
        ...
        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['updateAction'])) {
            ...
            try {
                ...
                $adviceChain = $adviceChains['Neos\Flow\Aop\Advice\AroundAdvice'];
                $adviceChain->rewind();
                $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\Neos\Controller\Module\User\UserSettingsController', 'updateAction', $methodArguments, $adviceChain);
                $result = $adviceChain->proceed($joinPoint);
                $methodArguments = $joinPoint->getMethodArguments();
    ...
    public function editAccountAction(\Neos\Flow\Security\Account $account)
    {
        ...
        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['editAccountAction'])) {
            ...
            try {
                ...
                $adviceChain = $adviceChains['Neos\Flow\Aop\Advice\AroundAdvice'];
                $adviceChain->rewind();
                $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\Neos\Controller\Module\User\UserSettingsController', 'editAccountAction', $methodArguments, $adviceChain);
                $result = $adviceChain->proceed($joinPoint);
                $methodArguments = $joinPoint->getMethodArguments();
    ...
    public function updateAccountAction(array $password = array())
    {
        ...
        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['updateAccountAction'])) {
            $result = parent::updateAccountAction($password);
            ...
            try {
                ...
                $adviceChain = $adviceChains['Neos\Flow\Aop\Advice\AroundAdvice'];
                $adviceChain->rewind();
                $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\Neos\Controller\Module\User\UserSettingsController', 'updateAccountAction', $methodArguments, $adviceChain);
                $result = $adviceChain->proceed($joinPoint);
                $methodArguments = $joinPoint->getMethodArguments();
    ...
    public function newElectronicAddressAction(\Neos\Neos\Domain\Model\User $user)
    {
        ...
        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['newElectronicAddressAction'])) {
            ...
            try {
                ...
                $adviceChain = $adviceChains['Neos\Flow\Aop\Advice\AroundAdvice'];
                $adviceChain->rewind();
                $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\Neos\Controller\Module\User\UserSettingsController', 'newElectronicAddressAction', $methodArguments, $adviceChain);
                $result = $adviceChain->proceed($joinPoint);
                $methodArguments = $joinPoint->getMethodArguments();
    ...
    public function createElectronicAddressAction(\Neos\Neos\Domain\Model\User $user, \Neos\Party\Domain\Model\ElectronicAddress $electronicAddress)
    {
        ...
        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['createElectronicAddressAction'])) {
            ...
            try {
                ...
                $adviceChain = $adviceChains['Neos\Flow\Aop\Advice\AroundAdvice'];
                $adviceChain->rewind();
                $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\Neos\Controller\Module\User\UserSettingsController', 'createElectronicAddressAction', $methodArguments, $adviceChain);
                $result = $adviceChain->proceed($joinPoint);
                $methodArguments = $joinPoint->getMethodArguments();
    ...
    public function deleteElectronicAddressAction(\Neos\Neos\Domain\Model\User $user, \Neos\Party\Domain\Model\ElectronicAddress $electronicAddress)
    {
        ...
        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['deleteElectronicAddressAction'])) {
            ...
            try {
                ...
                $adviceChain = $adviceChains['Neos\Flow\Aop\Advice\AroundAdvice'];
                $adviceChain->rewind();
                $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\Neos\Controller\Module\User\UserSettingsController', 'deleteElectronicAddressAction', $methodArguments, $adviceChain);
                $result = $adviceChain->proceed($joinPoint);
                $methodArguments = $joinPoint->getMethodArguments();
...
# PathAndFilename: /var/www/html/neos/Packages/Application/Neos.Neos/Classes/Controller/Module/User/UserSettingsController.php
#