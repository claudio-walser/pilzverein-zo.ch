...
class TestingProvider extends TestingProvider_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    public function __construct()
    {
        ...
        if (!array_key_exists(0, $arguments)) $arguments[0] = 'TestingProvider';
...
# PathAndFilename: /var/www/html/neos/Packages/Framework/Neos.Flow/Classes/Security/Authentication/Provider/TestingProvider.php
#