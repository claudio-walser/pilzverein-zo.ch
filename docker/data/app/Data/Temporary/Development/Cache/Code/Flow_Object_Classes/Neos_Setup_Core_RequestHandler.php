...
class RequestHandler extends RequestHandler_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    public function __construct()
    {
        ...
        if (get_class($this) === 'Neos\Setup\Core\RequestHandler') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Setup\Core\RequestHandler', $this);
...
# PathAndFilename: /var/www/html/neos/Packages/Application/Neos.Setup/Classes/Core/RequestHandler.php
#