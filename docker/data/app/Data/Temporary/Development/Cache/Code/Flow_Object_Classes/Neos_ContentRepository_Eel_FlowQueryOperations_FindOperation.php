 ...
 * 	q(node).find('[instanceof Neos.NodeTypes:Text][text*="Neos"]')
 */
class FindOperation extends FindOperation_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if ('Neos\ContentRepository\Eel\FlowQueryOperations\FindOperation' === get_class($this)) {
...
# PathAndFilename: /var/www/html/neos/Packages/Application/Neos.ContentRepository/Classes/Eel/FlowQueryOperations/FindOperation.php
#