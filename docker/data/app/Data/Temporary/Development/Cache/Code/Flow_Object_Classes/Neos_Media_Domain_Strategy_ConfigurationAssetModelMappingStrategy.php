...
class ConfigurationAssetModelMappingStrategy extends ConfigurationAssetModelMappingStrategy_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
  ...
  'settings' => 'array',
    ...
    public function __wakeup()
    {
        ...
        $isClassProxy = array_search('Neos\Media\Domain\Strategy\ConfigurationAssetModelMappingStrategy', $classParents) !== false && array_search('Doctrine\ORM\Proxy\Proxy', $classImplements) !== false;
...
# PathAndFilename: /var/www/html/neos/Packages/Application/Neos.Media/Classes/Domain/Strategy/ConfigurationAssetModelMappingStrategy.php
#