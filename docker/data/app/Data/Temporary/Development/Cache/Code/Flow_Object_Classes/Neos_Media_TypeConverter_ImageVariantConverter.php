 ...
 */
class ImageVariantConverter_Original extends ImageInterfaceConverter
{
    /**
     * @var string
     */
 ...
 */
class ImageVariantConverter extends ImageVariantConverter_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\Media\TypeConverter\ImageVariantConverter') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Media\TypeConverter\ImageVariantConverter', $this);
        if ('Neos\Media\TypeConverter\ImageVariantConverter' === get_class($this)) {
...
# PathAndFilename: /var/www/html/neos/Packages/Application/Neos.Media/Classes/TypeConverter/ImageVariantConverter.php
#