 ...
 */
class DimensionController_Original extends AbstractModuleController
{
    /**
     * @Flow\Inject
 ...
 * The Neos Dimension module controller
 */
class DimensionController extends DimensionController_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    public function __construct()
    {
        ...
        if ('Neos\Neos\Controller\Module\Administration\DimensionController' === get_class($this)) {
            $this->Flow_Proxy_injectProperties();
        }

        $isSameClass = get_class($this) === 'Neos\Neos\Controller\Module\Administration\DimensionController';
        if ($isSameClass) {
    ...
    public function __wakeup()
    {
        ...
        $isClassProxy = array_search('Neos\Neos\Controller\Module\Administration\DimensionController', $classParents) !== false && array_search('Doctrine\ORM\Proxy\Proxy', $classImplements) !== false;
    ...
    public function indexAction(string $type = 'intraDimension', ?string $subgraphIdentifier = NULL)
    {
        ...
        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['indexAction'])) {
            $result = parent::indexAction($type, $subgraphIdentifier);
            ...
            try {
                ...
                $methodArguments['subgraphIdentifier'] = $subgraphIdentifier;
            
                $adviceChains = $this->Flow_Aop_Proxy_getAdviceChains('indexAction');
                $adviceChain = $adviceChains['Neos\Flow\Aop\Advice\AroundAdvice'];
                $adviceChain->rewind();
                $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\Neos\Controller\Module\Administration\DimensionController', 'indexAction', $methodArguments, $adviceChain);
  ...
  'fallbackGraphService' => 'Neos\\ContentRepository\\Service\\FallbackGraphService',
  ...
  '_userService' => '\\Neos\\Neos\\Service\\UserService',
    ...
    private function Flow_Proxy_injectProperties()
    {
        ...
        $this->Flow_Proxy_LazyPropertyInjection('Neos\ContentRepository\Service\FallbackGraphService', 'Neos\ContentRepository\Service\FallbackGraphService', 'fallbackGraphService', '273456c8449f596b4d765c5f320d6ded', function() { return \Neos\Flow\Core\Bootstrap::$staticObjectManager->get('Neos\ContentRepository\Service\FallbackGraphService'); });
...
# PathAndFilename: /var/www/html/neos/Packages/Application/Neos.Neos/Classes/Controller/Module/Administration/DimensionController.php
#