 ...
 */
class NodeImportService extends NodeImportService_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\ContentRepository\Domain\Service\ImportExport\NodeImportService') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\ContentRepository\Domain\Service\ImportExport\NodeImportService', $this);
        if ('Neos\ContentRepository\Domain\Service\ImportExport\NodeImportService' === get_class($this)) {
...
# PathAndFilename: /var/www/html/neos/Packages/Application/Neos.ContentRepository/Classes/Domain/Service/ImportExport/NodeImportService.php
#