...
class ImageController extends ImageController_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
     ...
     * @throws \Neos\Flow\Mvc\Exception\UnsupportedRequestTypeException
     */
    public function editAction(?string $assetSourceIdentifier = NULL, ?string $assetProxyIdentifier = NULL, ?\Neos\Media\Domain\Model\Asset $asset = NULL) : void
    {
    ...
    public function updateImageVariantAction(\Neos\Media\Domain\Model\ImageVariant $imageVariant)
    {
        ...
        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['updateImageVariantAction'])) {
            ...
            try {
                ...
                $adviceChain = $adviceChains['Neos\Flow\Aop\Advice\AroundAdvice'];
                $adviceChain->rewind();
                $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\Media\Browser\Controller\ImageController', 'updateImageVariantAction', $methodArguments, $adviceChain);
                $result = $adviceChain->proceed($joinPoint);
                $methodArguments = $joinPoint->getMethodArguments();
  ...
  24 => '_userService',
  25 => 'imageProfilesConfiguration',
  26 => 'defaultViewImplementation',
);
    }
}
# PathAndFilename: /var/www/html/neos/Packages/Application/Neos.Media.Browser/Classes/Controller/ImageController.php
#