 ...
 */
class HtmlAugmenter extends HtmlAugmenter_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\Fusion\Service\HtmlAugmenter') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Fusion\Service\HtmlAugmenter', $this);
    }
...
# PathAndFilename: /var/www/html/neos/Packages/Application/Neos.Fusion/Classes/Service/HtmlAugmenter.php
#