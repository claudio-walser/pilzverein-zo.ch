 ...
 */
class NodePropertyConverterService_Original
{
    /**
 ...
 */
class NodePropertyConverterService extends NodePropertyConverterService_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\Neos\Service\Mapping\NodePropertyConverterService') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Neos\Service\Mapping\NodePropertyConverterService', $this);
        if ('Neos\Neos\Service\Mapping\NodePropertyConverterService' === get_class($this)) {
  ...
  0 => 'generatedPropertyMappingConfigurations',
);
  ...
  'throwableStorage' => 'Neos\\Flow\\Log\\ThrowableStorageInterface',
    ...
    private function Flow_Proxy_injectProperties()
    {
        ...
        $this->typesConfiguration = \Neos\Flow\Core\Bootstrap::$staticObjectManager->get(\Neos\Flow\Configuration\ConfigurationManager::class)->getConfiguration('Settings', 'Neos.Neos.userInterface.inspector.dataTypes');
        $this->Flow_Injected_Properties = array (
  0 => 'logger',
  1 => 'throwableStorage',
  2 => 'objectManager',
  3 => 'propertyMapper',
  4 => 'typesConfiguration',
);
    }
}
# PathAndFilename: /var/www/html/neos/Packages/Application/Neos.Neos/Classes/Service/Mapping/NodePropertyConverterService.php
#