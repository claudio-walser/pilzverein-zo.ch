 ...
 */
class ImageService extends ImageService_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\Media\Domain\Service\ImageService') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Media\Domain\Service\ImageService', $this);
        if ('Neos\Media\Domain\Service\ImageService' === get_class($this)) {
  ...
  'allowedFormats' => 'array<string>',
    ...
    {
        $this->Flow_Proxy_LazyPropertyInjection('', '', 'imagineService', '55f1097b23a25e0fc0a6b76cb41d50a2', function() { return \Neos\Flow\Core\Bootstrap::$staticObjectManager->get('Neos\Imagine\ImagineFactory')->create(); });
        $this->Flow_Proxy_LazyPropertyInjection('', '', 'imageSizeCache', '92c95305e16f0f7fb66db62afd60342f', function() { return \Neos\Flow\Core\Bootstrap::$staticObjectManager->get('Neos\Flow\Cache\CacheManager')->getCache('Neos_Media_ImageSize'); });
...
# PathAndFilename: /var/www/html/neos/Packages/Application/Neos.Media/Classes/Domain/Service/ImageService.php
#