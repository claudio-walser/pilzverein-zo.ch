 ...
 */
class SequenceMatcher_Original
{
    /**
 ...
 * A Diff Sequence Matcher
 */
class SequenceMatcher extends SequenceMatcher_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    public function __construct()
    {
        ...
        if (!array_key_exists(2, $arguments)) throw new \Neos\Flow\ObjectManagement\Exception\UnresolvedDependenciesException('Missing required constructor argument $junkCallback in class ' . __CLASS__ . '. Note that constructor injection is only support for objects of scope singleton (and this is not a singleton) – for other scopes you must pass each required argument to the constructor yourself.', 1296143788);
        if (!array_key_exists(3, $arguments)) throw new \Neos\Flow\ObjectManagement\Exception\UnresolvedDependenciesException('Missing required constructor argument $options in class ' . __CLASS__ . '. Note that constructor injection is only support for objects of scope singleton (and this is not a singleton) – for other scopes you must pass each required argument to the constructor yourself.', 1296143788);
  ...
  'junkCallback' => 'string|array Either a string or an array containing a callback function to determine if a line is "junk" or not.',
  'a' => 'array The first sequence to compare against.',
  'b' => 'array The second sequence.',
  'junkDict' => 'array Array of characters that are considered junk from the second sequence. Characters are the array key.',
  'b2j' => 'array Array of indices that do not contain junk elements.',
  'options' => 'array',
...
# PathAndFilename: /var/www/html/neos/Packages/Application/Neos.Diff/Classes/SequenceMatcher.php
#