...
class ContentStream extends ContentStream_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
  ...
  'logger' => 'Psr\\Log\\LoggerInterface',
    ...
    {
        $this->Flow_Proxy_LazyPropertyInjection('', '', 'logger', '6fb4f178c3cabce54e3de7398676ac11', function() { return \Neos\Flow\Core\Bootstrap::$staticObjectManager->get('Neos\Flow\Log\PsrLoggerFactoryInterface')->get('systemLogger'); });
        $this->Flow_Injected_Properties = array (
  0 => 'logger',
);
    }
}
# PathAndFilename: /var/www/html/neos/Packages/Framework/Neos.Flow/Classes/Http/ContentStream.php
#