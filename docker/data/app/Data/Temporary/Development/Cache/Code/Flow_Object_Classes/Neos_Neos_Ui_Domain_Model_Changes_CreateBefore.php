...
class CreateBefore_Original extends AbstractCreate
{
    /**
 ...
 * 
 */
class CreateBefore extends CreateBefore_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    public function __construct()
    {
        ...
        if ('Neos\Neos\Ui\Domain\Model\Changes\CreateBefore' === get_class($this)) {
    ...
    public function emitNodeCreationHandlersApplied(\Neos\ContentRepository\Domain\Model\NodeInterface $node)
    {
        ...
        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitNodeCreationHandlersApplied'])) {
            ...
            try {
                ...
                $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\Neos\Ui\Domain\Model\Changes\CreateBefore', 'emitNodeCreationHandlersApplied', $methodArguments);
                ...
                if (isset($this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitNodeCreationHandlersApplied']['Neos\Flow\Aop\Advice\AfterReturningAdvice'])) {
                    ...
                    $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\Neos\Ui\Domain\Model\Changes\CreateBefore', 'emitNodeCreationHandlersApplied', $methodArguments, NULL, $result);
...
# PathAndFilename: /var/www/html/neos/Packages/Application/Neos.Neos.Ui/Classes/Domain/Model/Changes/CreateBefore.php
#