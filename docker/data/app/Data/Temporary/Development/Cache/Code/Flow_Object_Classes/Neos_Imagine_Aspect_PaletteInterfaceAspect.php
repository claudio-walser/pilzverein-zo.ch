 ...
 */
class PaletteInterfaceAspect extends PaletteInterfaceAspect_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if ('Neos\Imagine\Aspect\PaletteInterfaceAspect' === get_class($this)) {
  ...
  'profiles' => 'array',
    ...
    private function Flow_Proxy_injectProperties()
    {
        ...
        $this->profiles = \Neos\Flow\Core\Bootstrap::$staticObjectManager->get(\Neos\Flow\Configuration\ConfigurationManager::class)->getConfiguration('Settings', 'Neos.Imagine.profile');
...
# PathAndFilename: /var/www/html/neos/Packages/Application/Neos.Imagine/Classes/Aspect/PaletteInterfaceAspect.php
#