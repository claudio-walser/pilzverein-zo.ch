 ...
 */
class ContentCache extends ContentCache_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    public function __construct()
    {
        if (get_class($this) === 'Neos\Fusion\Core\Cache\ContentCache') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Fusion\Core\Cache\ContentCache', $this);
        parent::__construct();
        if ('Neos\Fusion\Core\Cache\ContentCache' === get_class($this)) {
  ...
  'randomCacheMarker' => 'string',
    ...
    {
        $this->Flow_Proxy_LazyPropertyInjection('', '', 'cache', 'cfeb8772f36db6c7acae98926f2f0648', function() { return \Neos\Flow\Core\Bootstrap::$staticObjectManager->get('Neos\Flow\Cache\CacheManager')->getCache('Neos_Fusion_Content'); });
...
# PathAndFilename: /var/www/html/neos/Packages/Application/Neos.Fusion/Classes/Core/Cache/ContentCache.php
#