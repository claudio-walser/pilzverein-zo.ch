 ...
 * @api
 */
class Node_Original implements NodeInterface, CacheAwareInterface, TraversableNodeInterface
{
    /**
 ...
 */
class Node extends Node_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    public function __construct()
    {
        ...
        if ('Neos\ContentRepository\Domain\Model\Node' === get_class($this)) {
    ...
    protected function Flow_Aop_Proxy_buildMethodsAndAdvicesArray()
    {
        ...
        $this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices = array(
            'emitBeforeNodeMove' => array(
                'Neos\Flow\Aop\Advice\AfterReturningAdvice' => array(
                    new \Neos\Flow\Aop\Advice\AfterReturningAdvice('Neos\Flow\SignalSlot\SignalAspect', 'forwardSignalToDispatcher', $objectManager, NULL),
                ),
            ),
            'emitAfterNodeMove' => array(
                'Neos\Flow\Aop\Advice\AfterReturningAdvice' => array(
                    new \Neos\Flow\Aop\Advice\AfterReturningAdvice('Neos\Flow\SignalSlot\SignalAspect', 'forwardSignalToDispatcher', $objectManager, NULL),
                ),
            ),
            'emitBeforeNodeCopy' => array(
                'Neos\Flow\Aop\Advice\AfterReturningAdvice' => array(
                    new \Neos\Flow\Aop\Advice\AfterReturningAdvice('Neos\Flow\SignalSlot\SignalAspect', 'forwardSignalToDispatcher', $objectManager, NULL),
                ),
            ),
            'emitAfterNodeCopy' => array(
                'Neos\Flow\Aop\Advice\AfterReturningAdvice' => array(
                    new \Neos\Flow\Aop\Advice\AfterReturningAdvice('Neos\Flow\SignalSlot\SignalAspect', 'forwardSignalToDispatcher', $objectManager, NULL),
                ),
            ),
            ...
            'emitBeforeNodeCreate' => array(
                'Neos\Flow\Aop\Advice\AfterReturningAdvice' => array(
                    new \Neos\Flow\Aop\Advice\AfterReturningAdvice('Neos\Flow\SignalSlot\SignalAspect', 'forwardSignalToDispatcher', $objectManager, NULL),
                ),
            ),
            'emitAfterNodeCreate' => array(
                'Neos\Flow\Aop\Advice\AfterReturningAdvice' => array(
                    new \Neos\Flow\Aop\Advice\AfterReturningAdvice('Neos\Flow\SignalSlot\SignalAspect', 'forwardSignalToDispatcher', $objectManager, NULL),
                ),
            ),
            ...
            'emitBeforeNodePropertyChange' => array(
                'Neos\Flow\Aop\Advice\AfterReturningAdvice' => array(
                    new \Neos\Flow\Aop\Advice\AfterReturningAdvice('Neos\Flow\SignalSlot\SignalAspect', 'forwardSignalToDispatcher', $objectManager, NULL),
                ),
            ),
     ...
     */
    protected function emitBeforeNodeMove(\Neos\ContentRepository\Domain\Model\NodeInterface $movedNode, \Neos\ContentRepository\Domain\Model\NodeInterface $referenceNode, int $movePosition) : void
    {

        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitBeforeNodeMove'])) {
            parent::emitBeforeNodeMove($movedNode, $referenceNode, $movePosition);

        } else {
            $this->Flow_Aop_Proxy_methodIsInAdviceMode['emitBeforeNodeMove'] = true;
            try {
            
                $methodArguments = [];

                $methodArguments['movedNode'] = $movedNode;
                $methodArguments['referenceNode'] = $referenceNode;
                $methodArguments['movePosition'] = $movePosition;
            
                $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\ContentRepository\Domain\Model\Node', 'emitBeforeNodeMove', $methodArguments);
                $result = $this->Flow_Aop_Proxy_invokeJoinPoint($joinPoint);
                $methodArguments = $joinPoint->getMethodArguments();

                if (isset($this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitBeforeNodeMove']['Neos\Flow\Aop\Advice\AfterReturningAdvice'])) {
                    $advices = $this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitBeforeNodeMove']['Neos\Flow\Aop\Advice\AfterReturningAdvice'];
                    $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\ContentRepository\Domain\Model\Node', 'emitBeforeNodeMove', $methodArguments, NULL, $result);
                ...
                unset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitBeforeNodeMove']);
                throw $exception;
            }
            unset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitBeforeNodeMove']);
        }
     ...
     * @\Neos\Flow\Annotations\Signal
     */
    protected function emitAfterNodeMove(\Neos\ContentRepository\Domain\Model\NodeInterface $movedNode, \Neos\ContentRepository\Domain\Model\NodeInterface $referenceNode, int $movePosition) : void
    {

        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitAfterNodeMove'])) {
            parent::emitAfterNodeMove($movedNode, $referenceNode, $movePosition);

        } else {
            $this->Flow_Aop_Proxy_methodIsInAdviceMode['emitAfterNodeMove'] = true;
            try {
                ...
                $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\ContentRepository\Domain\Model\Node', 'emitAfterNodeMove', $methodArguments);
                $result = $this->Flow_Aop_Proxy_invokeJoinPoint($joinPoint);
                $methodArguments = $joinPoint->getMethodArguments();

                if (isset($this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitAfterNodeMove']['Neos\Flow\Aop\Advice\AfterReturningAdvice'])) {
                    $advices = $this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitAfterNodeMove']['Neos\Flow\Aop\Advice\AfterReturningAdvice'];
                    $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\ContentRepository\Domain\Model\Node', 'emitAfterNodeMove', $methodArguments, NULL, $result);
                    foreach ($advices as $advice) {
                        $advice->invoke($joinPoint);
                    }
                ...
                unset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitAfterNodeMove']);
                throw $exception;
            }
            unset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitAfterNodeMove']);
        }
     ...
     * @\Neos\Flow\Annotations\Signal
     */
    protected function emitBeforeNodeCopy(\Neos\ContentRepository\Domain\Model\NodeInterface $sourceNode, \Neos\ContentRepository\Domain\Model\NodeInterface $targetParentNode) : void
    {

        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitBeforeNodeCopy'])) {
            parent::emitBeforeNodeCopy($sourceNode, $targetParentNode);

        } else {
            $this->Flow_Aop_Proxy_methodIsInAdviceMode['emitBeforeNodeCopy'] = true;
            try {
            
                $methodArguments = [];

                $methodArguments['sourceNode'] = $sourceNode;
                $methodArguments['targetParentNode'] = $targetParentNode;
            
                $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\ContentRepository\Domain\Model\Node', 'emitBeforeNodeCopy', $methodArguments);
                $result = $this->Flow_Aop_Proxy_invokeJoinPoint($joinPoint);
                $methodArguments = $joinPoint->getMethodArguments();

                if (isset($this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitBeforeNodeCopy']['Neos\Flow\Aop\Advice\AfterReturningAdvice'])) {
                    $advices = $this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitBeforeNodeCopy']['Neos\Flow\Aop\Advice\AfterReturningAdvice'];
                    $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\ContentRepository\Domain\Model\Node', 'emitBeforeNodeCopy', $methodArguments, NULL, $result);
                    foreach ($advices as $advice) {
                        $advice->invoke($joinPoint);
                    }
                ...
                unset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitBeforeNodeCopy']);
                throw $exception;
            }
            unset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitBeforeNodeCopy']);
        }
     ...
     * @\Neos\Flow\Annotations\Signal
     */
    protected function emitAfterNodeCopy(\Neos\ContentRepository\Domain\Model\NodeInterface $copiedNode, \Neos\ContentRepository\Domain\Model\NodeInterface $targetParentNode) : void
    {

        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitAfterNodeCopy'])) {
            parent::emitAfterNodeCopy($copiedNode, $targetParentNode);

        } else {
            $this->Flow_Aop_Proxy_methodIsInAdviceMode['emitAfterNodeCopy'] = true;
            try {
            
                $methodArguments = [];

                $methodArguments['copiedNode'] = $copiedNode;
                $methodArguments['targetParentNode'] = $targetParentNode;
            
                $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\ContentRepository\Domain\Model\Node', 'emitAfterNodeCopy', $methodArguments);
                $result = $this->Flow_Aop_Proxy_invokeJoinPoint($joinPoint);
                $methodArguments = $joinPoint->getMethodArguments();

                if (isset($this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitAfterNodeCopy']['Neos\Flow\Aop\Advice\AfterReturningAdvice'])) {
                    $advices = $this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitAfterNodeCopy']['Neos\Flow\Aop\Advice\AfterReturningAdvice'];
                    $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\ContentRepository\Domain\Model\Node', 'emitAfterNodeCopy', $methodArguments, NULL, $result);
                    foreach ($advices as $advice) {
                        $advice->invoke($joinPoint);
                    }
                ...
                unset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitAfterNodeCopy']);
                throw $exception;
            }
            unset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitAfterNodeCopy']);
        }
     ...
     * @\Neos\Flow\Annotations\Signal
     */
    protected function emitNodePathChanged(\Neos\ContentRepository\Domain\Model\NodeInterface $node, $oldPath, $newPath, $recursion)
    {

        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitNodePathChanged'])) {
            $result = parent::emitNodePathChanged($node, $oldPath, $newPath, $recursion);
            ...
            try {
                ...
                $methodArguments['oldPath'] = $oldPath;
                $methodArguments['newPath'] = $newPath;
                $methodArguments['recursion'] = $recursion;
            
                $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\ContentRepository\Domain\Model\Node', 'emitNodePathChanged', $methodArguments);
                $result = $this->Flow_Aop_Proxy_invokeJoinPoint($joinPoint);
                $methodArguments = $joinPoint->getMethodArguments();

                if (isset($this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitNodePathChanged']['Neos\Flow\Aop\Advice\AfterReturningAdvice'])) {
                    $advices = $this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitNodePathChanged']['Neos\Flow\Aop\Advice\AfterReturningAdvice'];
                    $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\ContentRepository\Domain\Model\Node', 'emitNodePathChanged', $methodArguments, NULL, $result);
                    foreach ($advices as $advice) {
                        $advice->invoke($joinPoint);
                    }
     ...
     * @\Neos\Flow\Annotations\Signal
     */
    protected function emitBeforeNodeCreate(\Neos\ContentRepository\Domain\Model\NodeInterface $node, $name, $nodeType, $identifier)
    {

        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitBeforeNodeCreate'])) {
            $result = parent::emitBeforeNodeCreate($node, $name, $nodeType, $identifier);

        } else {
            $this->Flow_Aop_Proxy_methodIsInAdviceMode['emitBeforeNodeCreate'] = true;
            try {
                ...
                $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\ContentRepository\Domain\Model\Node', 'emitBeforeNodeCreate', $methodArguments);
                $result = $this->Flow_Aop_Proxy_invokeJoinPoint($joinPoint);
                $methodArguments = $joinPoint->getMethodArguments();

                if (isset($this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitBeforeNodeCreate']['Neos\Flow\Aop\Advice\AfterReturningAdvice'])) {
                    $advices = $this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitBeforeNodeCreate']['Neos\Flow\Aop\Advice\AfterReturningAdvice'];
                    $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\ContentRepository\Domain\Model\Node', 'emitBeforeNodeCreate', $methodArguments, NULL, $result);
                    foreach ($advices as $advice) {
                        $advice->invoke($joinPoint);
                    }
                ...
                unset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitBeforeNodeCreate']);
                throw $exception;
            }
            unset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitBeforeNodeCreate']);
        }
     ...
     * @\Neos\Flow\Annotations\Signal
     */
    protected function emitAfterNodeCreate(\Neos\ContentRepository\Domain\Model\NodeInterface $node)
    {

        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitAfterNodeCreate'])) {
            $result = parent::emitAfterNodeCreate($node);

        } else {
            $this->Flow_Aop_Proxy_methodIsInAdviceMode['emitAfterNodeCreate'] = true;
            try {
                ...
                $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\ContentRepository\Domain\Model\Node', 'emitAfterNodeCreate', $methodArguments);
                $result = $this->Flow_Aop_Proxy_invokeJoinPoint($joinPoint);
                $methodArguments = $joinPoint->getMethodArguments();

                if (isset($this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitAfterNodeCreate']['Neos\Flow\Aop\Advice\AfterReturningAdvice'])) {
                    $advices = $this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitAfterNodeCreate']['Neos\Flow\Aop\Advice\AfterReturningAdvice'];
                    $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\ContentRepository\Domain\Model\Node', 'emitAfterNodeCreate', $methodArguments, NULL, $result);
                    foreach ($advices as $advice) {
                        $advice->invoke($joinPoint);
                    }
                ...
                unset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitAfterNodeCreate']);
                throw $exception;
            }
            unset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitAfterNodeCreate']);
        }
     ...
     * @\Neos\Flow\Annotations\Signal
     */
    protected function emitNodeAdded(\Neos\ContentRepository\Domain\Model\NodeInterface $node)
    {
        ...
        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitNodeAdded'])) {
            ...
            try {
                ...
                $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\ContentRepository\Domain\Model\Node', 'emitNodeAdded', $methodArguments);
                $result = $this->Flow_Aop_Proxy_invokeJoinPoint($joinPoint);
                $methodArguments = $joinPoint->getMethodArguments();

                if (isset($this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitNodeAdded']['Neos\Flow\Aop\Advice\AfterReturningAdvice'])) {
                    $advices = $this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitNodeAdded']['Neos\Flow\Aop\Advice\AfterReturningAdvice'];
                    $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\ContentRepository\Domain\Model\Node', 'emitNodeAdded', $methodArguments, NULL, $result);
                    foreach ($advices as $advice) {
                        $advice->invoke($joinPoint);
                    }
     ...
     * @\Neos\Flow\Annotations\Signal
     */
    protected function emitNodeUpdated(\Neos\ContentRepository\Domain\Model\NodeInterface $node)
    {
        ...
        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitNodeUpdated'])) {
            ...
            try {
                ...
                $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\ContentRepository\Domain\Model\Node', 'emitNodeUpdated', $methodArguments);
                $result = $this->Flow_Aop_Proxy_invokeJoinPoint($joinPoint);
                $methodArguments = $joinPoint->getMethodArguments();

                if (isset($this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitNodeUpdated']['Neos\Flow\Aop\Advice\AfterReturningAdvice'])) {
                    $advices = $this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitNodeUpdated']['Neos\Flow\Aop\Advice\AfterReturningAdvice'];
                    $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\ContentRepository\Domain\Model\Node', 'emitNodeUpdated', $methodArguments, NULL, $result);
                    foreach ($advices as $advice) {
                        $advice->invoke($joinPoint);
                    }
     ...
     * @\Neos\Flow\Annotations\Signal
     */
    protected function emitNodeRemoved(\Neos\ContentRepository\Domain\Model\NodeInterface $node)
    {
        ...
        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitNodeRemoved'])) {
            ...
            try {
                ...
                $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\ContentRepository\Domain\Model\Node', 'emitNodeRemoved', $methodArguments);
                $result = $this->Flow_Aop_Proxy_invokeJoinPoint($joinPoint);
                $methodArguments = $joinPoint->getMethodArguments();

                if (isset($this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitNodeRemoved']['Neos\Flow\Aop\Advice\AfterReturningAdvice'])) {
                    $advices = $this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitNodeRemoved']['Neos\Flow\Aop\Advice\AfterReturningAdvice'];
                    $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\ContentRepository\Domain\Model\Node', 'emitNodeRemoved', $methodArguments, NULL, $result);
                    foreach ($advices as $advice) {
                        $advice->invoke($joinPoint);
                    }
     ...
     * @\Neos\Flow\Annotations\Signal
     */
    protected function emitBeforeNodePropertyChange(\Neos\ContentRepository\Domain\Model\NodeInterface $node, $propertyName, $oldValue, $newValue)
    {

        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitBeforeNodePropertyChange'])) {
            $result = parent::emitBeforeNodePropertyChange($node, $propertyName, $oldValue, $newValue);

        } else {
            $this->Flow_Aop_Proxy_methodIsInAdviceMode['emitBeforeNodePropertyChange'] = true;
            try {
                ...
                $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\ContentRepository\Domain\Model\Node', 'emitBeforeNodePropertyChange', $methodArguments);
                $result = $this->Flow_Aop_Proxy_invokeJoinPoint($joinPoint);
                $methodArguments = $joinPoint->getMethodArguments();

                if (isset($this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitBeforeNodePropertyChange']['Neos\Flow\Aop\Advice\AfterReturningAdvice'])) {
                    $advices = $this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitBeforeNodePropertyChange']['Neos\Flow\Aop\Advice\AfterReturningAdvice'];
                    $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\ContentRepository\Domain\Model\Node', 'emitBeforeNodePropertyChange', $methodArguments, NULL, $result);
                    foreach ($advices as $advice) {
                        $advice->invoke($joinPoint);
                    }
                ...
                unset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitBeforeNodePropertyChange']);
                throw $exception;
            }
            unset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitBeforeNodePropertyChange']);
        }
     ...
     * @\Neos\Flow\Annotations\Signal
     */
    protected function emitNodePropertyChanged(\Neos\ContentRepository\Domain\Model\NodeInterface $node, $propertyName, $oldValue, $newValue)
    {
        ...
        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitNodePropertyChanged'])) {
            ...
            try {
                ...
                $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\ContentRepository\Domain\Model\Node', 'emitNodePropertyChanged', $methodArguments);
                $result = $this->Flow_Aop_Proxy_invokeJoinPoint($joinPoint);
                $methodArguments = $joinPoint->getMethodArguments();

                if (isset($this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitNodePropertyChanged']['Neos\Flow\Aop\Advice\AfterReturningAdvice'])) {
                    $advices = $this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitNodePropertyChanged']['Neos\Flow\Aop\Advice\AfterReturningAdvice'];
                    $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\ContentRepository\Domain\Model\Node', 'emitNodePropertyChanged', $methodArguments, NULL, $result);
                    foreach ($advices as $advice) {
                        $advice->invoke($joinPoint);
                    }
  ...
  'nodeDataIsMatchingContext' => 'boolean',
...
# PathAndFilename: /var/www/html/neos/Packages/Application/Neos.ContentRepository/Classes/Domain/Model/Node.php
#