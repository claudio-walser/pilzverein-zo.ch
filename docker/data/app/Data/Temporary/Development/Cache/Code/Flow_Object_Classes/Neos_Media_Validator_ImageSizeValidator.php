 ...
 */
class ImageSizeValidator_Original extends AbstractValidator
{
    /**
     * @var array
     */
 ...
 * [at]Flow\Validate("$image", type="\Neos\Media\Validator\ImageSizeValidator", options={ "minimumWidth"=150, "maximumResolution"=60000 })
 */
class ImageSizeValidator extends ImageSizeValidator_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
...
# PathAndFilename: /var/www/html/neos/Packages/Application/Neos.Media/Classes/Validator/ImageSizeValidator.php
#