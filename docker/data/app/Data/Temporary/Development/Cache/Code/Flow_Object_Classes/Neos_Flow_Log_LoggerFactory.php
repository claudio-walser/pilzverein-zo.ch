...
class LoggerFactory extends LoggerFactory_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    public function __construct()
    {
        ...
        if (!array_key_exists(1, $arguments)) throw new \Neos\Flow\ObjectManagement\Exception\UnresolvedDependenciesException('Missing required constructor argument $throwableStorage in class ' . __CLASS__ . '. Please check your calling code and Dependency Injection configuration.', 1296143787);
...
# PathAndFilename: /var/www/html/neos/Packages/Framework/Neos.Flow/Classes/Log/LoggerFactory.php
#