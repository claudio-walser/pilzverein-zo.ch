 ...
 */
class NodePropertyValidationService_Original
{
 ...
 */
class NodePropertyValidationService extends NodePropertyValidationService_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\Neos\Ui\Service\NodePropertyValidationService') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Neos\Ui\Service\NodePropertyValidationService', $this);
        if ('Neos\Neos\Ui\Service\NodePropertyValidationService' === get_class($this)) {
  ...
  'dateTimeConverter' => 'Neos\\Flow\\Property\\TypeConverter\\DateTimeConverter',
);
    ...
    private function Flow_Proxy_injectProperties()
    {
        ...
        $this->Flow_Proxy_LazyPropertyInjection('Neos\Flow\Property\TypeConverter\DateTimeConverter', 'Neos\Flow\Property\TypeConverter\DateTimeConverter', 'dateTimeConverter', '7f64ebffe8e51db41a34bb6530ddb2f8', function() { return \Neos\Flow\Core\Bootstrap::$staticObjectManager->get('Neos\Flow\Property\TypeConverter\DateTimeConverter'); });
...
# PathAndFilename: /var/www/html/neos/Packages/Application/Neos.Neos.Ui/Classes/Service/NodePropertyValidationService.php
#