 ...
 */
class NodeTypeManager extends NodeTypeManager_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\ContentRepository\Domain\Service\NodeTypeManager') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\ContentRepository\Domain\Service\NodeTypeManager', $this);
        if ('Neos\ContentRepository\Domain\Service\NodeTypeManager' === get_class($this)) {
  ...
  'cachedNodeTypes' => 'array',
  'cachedSubNodeTypes' => 'array',
  ...
  'fullNodeTypeConfigurations' => 'array',
    ...
    {
        $this->Flow_Proxy_LazyPropertyInjection('', '', 'fullConfigurationCache', 'ecf7230f4c4af3cf587a62ff50629ad0', function() { return \Neos\Flow\Core\Bootstrap::$staticObjectManager->get('Neos\Flow\Cache\CacheManager')->getCache('Neos_ContentRepository_FullNodeTypeConfiguration'); });
        ...
        $this->fallbackNodeTypeName = \Neos\Flow\Core\Bootstrap::$staticObjectManager->get(\Neos\Flow\Configuration\ConfigurationManager::class)->getConfiguration('Settings', 'Neos.ContentRepository.fallbackNodeType');
        $this->Flow_Injected_Properties = array (
  0 => 'fullConfigurationCache',
  1 => 'configurationManager',
  2 => 'fallbackNodeTypeName',
);
    }
}
# PathAndFilename: /var/www/html/neos/Packages/Application/Neos.ContentRepository/Classes/Domain/Service/NodeTypeManager.php
#