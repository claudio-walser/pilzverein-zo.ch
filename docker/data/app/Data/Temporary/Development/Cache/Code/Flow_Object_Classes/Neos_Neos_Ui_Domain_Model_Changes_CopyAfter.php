...
class CopyAfter_Original extends AbstractCopy
{
 ...
 * 
 */
class CopyAfter extends CopyAfter_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if ('Neos\Neos\Ui\Domain\Model\Changes\CopyAfter' === get_class($this)) {
...
# PathAndFilename: /var/www/html/neos/Packages/Application/Neos.Neos.Ui/Classes/Domain/Model/Changes/CopyAfter.php
#