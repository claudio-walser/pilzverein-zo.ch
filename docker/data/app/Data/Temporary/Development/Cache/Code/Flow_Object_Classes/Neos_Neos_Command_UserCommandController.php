 ...
 */
class UserCommandController extends UserCommandController_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\Neos\Command\UserCommandController') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Neos\Command\UserCommandController', $this);
        parent::__construct();
        if ('Neos\Neos\Command\UserCommandController' === get_class($this)) {
...
# PathAndFilename: /var/www/html/neos/Packages/Application/Neos.Neos/Classes/Command/UserCommandController.php
#