    ...
    public function indexAction($currentPage = 1)
    {
        ...
        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['indexAction'])) {
            ...
            try {
                ...
                $adviceChain->rewind();
                $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\FluidAdaptor\ViewHelpers\Widget\Controller\PaginateController', 'indexAction', $methodArguments, $adviceChain);
...
# PathAndFilename: /var/www/html/neos/Packages/Framework/Neos.FluidAdaptor/Classes/ViewHelpers/Widget/Controller/PaginateController.php
#