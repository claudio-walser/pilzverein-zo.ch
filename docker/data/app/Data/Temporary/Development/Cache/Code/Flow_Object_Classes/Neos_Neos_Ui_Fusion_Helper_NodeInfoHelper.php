 ...
 */
class NodeInfoHelper_Original implements ProtectedContextAwareInterface
{
    /**
     * @Flow\Inject
 ...
 */
class NodeInfoHelper extends NodeInfoHelper_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\Neos\Ui\Fusion\Helper\NodeInfoHelper') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Neos\Ui\Fusion\Helper\NodeInfoHelper', $this);
        if ('Neos\Neos\Ui\Fusion\Helper\NodeInfoHelper' === get_class($this)) {
  ...
  'baseNodeType' => 'string',
  'loadingDepth' => 'string',
  'documentNodeTypeRole' => 'string',
  'ignoredNodeTypeRole' => 'string',
);
    ...
    private function Flow_Proxy_injectProperties()
    {
        ...
        $this->baseNodeType = \Neos\Flow\Core\Bootstrap::$staticObjectManager->get(\Neos\Flow\Configuration\ConfigurationManager::class)->getConfiguration('Settings', 'Neos.Neos.userInterface.navigateComponent.nodeTree.presets.default.baseNodeType');
        $this->loadingDepth = \Neos\Flow\Core\Bootstrap::$staticObjectManager->get(\Neos\Flow\Configuration\ConfigurationManager::class)->getConfiguration('Settings', 'Neos.Neos.userInterface.navigateComponent.nodeTree.loadingDepth');
        $this->documentNodeTypeRole = \Neos\Flow\Core\Bootstrap::$staticObjectManager->get(\Neos\Flow\Configuration\ConfigurationManager::class)->getConfiguration('Settings', 'Neos.Neos.Ui.nodeTypeRoles.document');
        $this->ignoredNodeTypeRole = \Neos\Flow\Core\Bootstrap::$staticObjectManager->get(\Neos\Flow\Configuration\ConfigurationManager::class)->getConfiguration('Settings', 'Neos.Neos.Ui.nodeTypeRoles.ignored');
        $this->Flow_Injected_Properties = array (
  0 => 'nodePolicyService',
  1 => 'userLocaleService',
  2 => 'linkingService',
  3 => 'entityToIdentityConverter',
  4 => 'persistenceManager',
  5 => 'nodePropertyConverterService',
  6 => 'baseNodeType',
  7 => 'loadingDepth',
  8 => 'documentNodeTypeRole',
  9 => 'ignoredNodeTypeRole',
);
    }
}
# PathAndFilename: /var/www/html/neos/Packages/Application/Neos.Neos.Ui/Classes/Fusion/Helper/NodeInfoHelper.php
#