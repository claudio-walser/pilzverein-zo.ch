...
class ConfigurationContentDimensionPresetSource extends ConfigurationContentDimensionPresetSource_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\ContentRepository\Domain\Service\ConfigurationContentDimensionPresetSource') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\ContentRepository\Domain\Service\ConfigurationContentDimensionPresetSource', $this);
        if ('Neos\ContentRepository\Domain\Service\ConfigurationContentDimensionPresetSource' === get_class($this)) {
...
# PathAndFilename: /var/www/html/neos/Packages/Application/Neos.ContentRepository/Classes/Domain/Service/ConfigurationContentDimensionPresetSource.php
#