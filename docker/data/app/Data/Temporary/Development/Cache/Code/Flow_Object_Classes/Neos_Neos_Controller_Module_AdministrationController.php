 ...
 */
class AdministrationController_Original extends AbstractModuleController
{
}
 ...
 */
class AdministrationController extends AdministrationController_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    public function __construct()
    {
        ...
        if (get_class($this) === 'Neos\Neos\Controller\Module\AdministrationController') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Neos\Controller\Module\AdministrationController', $this);
        if ('Neos\Neos\Controller\Module\AdministrationController' === get_class($this)) {
            $this->Flow_Proxy_injectProperties();
        }

        $isSameClass = get_class($this) === 'Neos\Neos\Controller\Module\AdministrationController';
        if ($isSameClass) {
    ...
    public function __wakeup()
    {
        ...
        $isClassProxy = array_search('Neos\Neos\Controller\Module\AdministrationController', $classParents) !== false && array_search('Doctrine\ORM\Proxy\Proxy', $classImplements) !== false;
    ...
    public function indexAction()
    {
        ...
        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['indexAction'])) {
            ...
            try {
                ...
                $adviceChain->rewind();
                $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\Neos\Controller\Module\AdministrationController', 'indexAction', $methodArguments, $adviceChain);
...
# PathAndFilename: /var/www/html/neos/Packages/Application/Neos.Neos/Classes/Controller/Module/AdministrationController.php
#