...
class SessionDataContainer extends SessionDataContainer_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
     ...
     * @return RequestInterface
     */
    public function getInterceptedRequest() : ?\Neos\Flow\Mvc\RequestInterface
    {
     ...
     * @param RequestInterface $interceptedRequest
     */
    public function setInterceptedRequest(?\Neos\Flow\Mvc\RequestInterface $interceptedRequest = NULL) : void
    {
  ...
  'interceptedRequest' => 'Neos\\Flow\\Mvc\\RequestInterface|null',
);
        $result = $this->Flow_serializeRelatedEntities($transientProperties, $propertyVarTags);
        return $result;
    }
}
# PathAndFilename: /var/www/html/neos/Packages/Framework/Neos.Flow/Classes/Security/SessionDataContainer.php
#