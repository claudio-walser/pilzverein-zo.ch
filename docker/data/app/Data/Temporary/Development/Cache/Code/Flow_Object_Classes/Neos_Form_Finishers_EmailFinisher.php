 ...
 */
class EmailFinisher_Original extends AbstractFinisher
{
 ...
 * - testMode: if TRUE the email is not actually sent but outputted for debugging purposes. Defaults to FALSE
 */
class EmailFinisher extends EmailFinisher_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if ('Neos\Form\Finishers\EmailFinisher' === get_class($this)) {
...
# PathAndFilename: /var/www/html/neos/Packages/Application/Neos.Form/Classes/Finishers/EmailFinisher.php
#