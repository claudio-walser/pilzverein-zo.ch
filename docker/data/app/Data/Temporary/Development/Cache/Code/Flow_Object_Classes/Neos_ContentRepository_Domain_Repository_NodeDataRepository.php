 ...
 */
class NodeDataRepository extends NodeDataRepository_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    public function __construct()
    {
        ...
        if (get_class($this) === 'Neos\ContentRepository\Domain\Repository\NodeDataRepository') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\ContentRepository\Domain\Repository\NodeDataRepository', $this);
        parent::__construct();
        if ('Neos\ContentRepository\Domain\Repository\NodeDataRepository' === get_class($this)) {
    ...
    protected function emitRepositoryObjectsPersisted()
    {
        ...
        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitRepositoryObjectsPersisted'])) {
            ...
            try {
                ...
                $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\ContentRepository\Domain\Repository\NodeDataRepository', 'emitRepositoryObjectsPersisted', $methodArguments);
                ...
                if (isset($this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitRepositoryObjectsPersisted']['Neos\Flow\Aop\Advice\AfterReturningAdvice'])) {
                    ...
                    $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\ContentRepository\Domain\Repository\NodeDataRepository', 'emitRepositoryObjectsPersisted', $methodArguments, NULL, $result);
...
# PathAndFilename: /var/www/html/neos/Packages/Application/Neos.ContentRepository/Classes/Domain/Repository/NodeDataRepository.php
#