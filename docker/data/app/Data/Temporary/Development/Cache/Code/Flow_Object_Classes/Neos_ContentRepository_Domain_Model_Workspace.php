 ...
 */
class Workspace extends Workspace_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface, \Neos\Flow\Persistence\Aspect\PersistenceMagicInterface {
    ...
    public function __construct()
    {
        ...
        if ('Neos\ContentRepository\Domain\Model\Workspace' === get_class($this)) {
            $this->Flow_Proxy_injectProperties();
        }

        $isSameClass = get_class($this) === 'Neos\ContentRepository\Domain\Model\Workspace';
        if ($isSameClass) {
    ...
    protected function Flow_Aop_Proxy_buildMethodsAndAdvicesArray()
    {
        ...
        $this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices = array(
            ...
            'emitBaseWorkspaceChanged' => array(
                'Neos\Flow\Aop\Advice\AfterReturningAdvice' => array(
    ...
    public function __wakeup()
    {
        ...
        $isClassProxy = array_search('Neos\ContentRepository\Domain\Model\Workspace', $classParents) !== false && array_search('Doctrine\ORM\Proxy\Proxy', $classImplements) !== false;
    ...
    public function __clone()
    {
        ...
        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['__clone'])) {
            ...
            try {
                ...
                $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\ContentRepository\Domain\Model\Workspace', '__clone', $methodArguments);
                ...
                if (isset($this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['__clone']['Neos\Flow\Aop\Advice\AfterReturningAdvice'])) {
                    ...
                    $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\ContentRepository\Domain\Model\Workspace', '__clone', $methodArguments, NULL, $result);
    ...
    public function publish(\Neos\ContentRepository\Domain\Model\Workspace $targetWorkspace)
    {
        ...
        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['publish'])) {
            $result = parent::publish($targetWorkspace);

        } else {
            $this->Flow_Aop_Proxy_methodIsInAdviceMode['publish'] = true;
            try {
                ...
                $adviceChains = $this->Flow_Aop_Proxy_getAdviceChains('publish');
                $adviceChain = $adviceChains['Neos\Flow\Aop\Advice\AroundAdvice'];
                $adviceChain->rewind();
                $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\ContentRepository\Domain\Model\Workspace', 'publish', $methodArguments, $adviceChain);
                $result = $adviceChain->proceed($joinPoint);
                $methodArguments = $joinPoint->getMethodArguments();

            } catch (\Exception $exception) {
                unset($this->Flow_Aop_Proxy_methodIsInAdviceMode['publish']);
                throw $exception;
            }
            unset($this->Flow_Aop_Proxy_methodIsInAdviceMode['publish']);
        }
    ...
    public function publishNodes(array $nodes, \Neos\ContentRepository\Domain\Model\Workspace $targetWorkspace)
    {
        ...
        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['publishNodes'])) {
            $result = parent::publishNodes($nodes, $targetWorkspace);

        } else {
            $this->Flow_Aop_Proxy_methodIsInAdviceMode['publishNodes'] = true;
            try {
                ...
                $adviceChains = $this->Flow_Aop_Proxy_getAdviceChains('publishNodes');
                $adviceChain = $adviceChains['Neos\Flow\Aop\Advice\AroundAdvice'];
                $adviceChain->rewind();
                $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\ContentRepository\Domain\Model\Workspace', 'publishNodes', $methodArguments, $adviceChain);
                $result = $adviceChain->proceed($joinPoint);
                $methodArguments = $joinPoint->getMethodArguments();

            } catch (\Exception $exception) {
                unset($this->Flow_Aop_Proxy_methodIsInAdviceMode['publishNodes']);
                throw $exception;
            }
            unset($this->Flow_Aop_Proxy_methodIsInAdviceMode['publishNodes']);
        }
    ...
    public function publishNode(\Neos\ContentRepository\Domain\Model\NodeInterface $nodeToPublish, \Neos\ContentRepository\Domain\Model\Workspace $targetWorkspace)
    {
        ...
        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['publishNode'])) {
            $result = parent::publishNode($nodeToPublish, $targetWorkspace);

        } else {
            $this->Flow_Aop_Proxy_methodIsInAdviceMode['publishNode'] = true;
            try {
            
                $methodArguments = [];

                $methodArguments['nodeToPublish'] = $nodeToPublish;
                $methodArguments['targetWorkspace'] = $targetWorkspace;
            
                $adviceChains = $this->Flow_Aop_Proxy_getAdviceChains('publishNode');
                $adviceChain = $adviceChains['Neos\Flow\Aop\Advice\AroundAdvice'];
                $adviceChain->rewind();
                $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\ContentRepository\Domain\Model\Workspace', 'publishNode', $methodArguments, $adviceChain);
                $result = $adviceChain->proceed($joinPoint);
                $methodArguments = $joinPoint->getMethodArguments();

            } catch (\Exception $exception) {
                unset($this->Flow_Aop_Proxy_methodIsInAdviceMode['publishNode']);
                throw $exception;
            }
            unset($this->Flow_Aop_Proxy_methodIsInAdviceMode['publishNode']);
        }
     ...
     */
    protected function emitBaseWorkspaceChanged(\Neos\ContentRepository\Domain\Model\Workspace $workspace, ?\Neos\ContentRepository\Domain\Model\Workspace $oldBaseWorkspace = NULL, ?\Neos\ContentRepository\Domain\Model\Workspace $newBaseWorkspace = NULL)
    {

        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitBaseWorkspaceChanged'])) {
            $result = parent::emitBaseWorkspaceChanged($workspace, $oldBaseWorkspace, $newBaseWorkspace);

        } else {
            $this->Flow_Aop_Proxy_methodIsInAdviceMode['emitBaseWorkspaceChanged'] = true;
            try {
            
                $methodArguments = [];

                $methodArguments['workspace'] = $workspace;
                $methodArguments['oldBaseWorkspace'] = $oldBaseWorkspace;
                $methodArguments['newBaseWorkspace'] = $newBaseWorkspace;
            
                $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\ContentRepository\Domain\Model\Workspace', 'emitBaseWorkspaceChanged', $methodArguments);
                $result = $this->Flow_Aop_Proxy_invokeJoinPoint($joinPoint);
                $methodArguments = $joinPoint->getMethodArguments();

                if (isset($this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitBaseWorkspaceChanged']['Neos\Flow\Aop\Advice\AfterReturningAdvice'])) {
                    $advices = $this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitBaseWorkspaceChanged']['Neos\Flow\Aop\Advice\AfterReturningAdvice'];
                    $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\ContentRepository\Domain\Model\Workspace', 'emitBaseWorkspaceChanged', $methodArguments, NULL, $result);
                    foreach ($advices as $advice) {
                        $advice->invoke($joinPoint);
                    }
                ...
                unset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitBaseWorkspaceChanged']);
                throw $exception;
            }
            unset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitBaseWorkspaceChanged']);
        }
     ...
     * @\Neos\Flow\Annotations\Signal
     */
    protected function emitBeforeNodePublishing(\Neos\ContentRepository\Domain\Model\NodeInterface $node, \Neos\ContentRepository\Domain\Model\Workspace $targetWorkspace)
    {
        ...
        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitBeforeNodePublishing'])) {
            ...
            try {
                ...
                $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\ContentRepository\Domain\Model\Workspace', 'emitBeforeNodePublishing', $methodArguments);
                $result = $this->Flow_Aop_Proxy_invokeJoinPoint($joinPoint);
                $methodArguments = $joinPoint->getMethodArguments();

                if (isset($this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitBeforeNodePublishing']['Neos\Flow\Aop\Advice\AfterReturningAdvice'])) {
                    $advices = $this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitBeforeNodePublishing']['Neos\Flow\Aop\Advice\AfterReturningAdvice'];
                    $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\ContentRepository\Domain\Model\Workspace', 'emitBeforeNodePublishing', $methodArguments, NULL, $result);
                    foreach ($advices as $advice) {
                        $advice->invoke($joinPoint);
                    }
     ...
     * @\Neos\Flow\Annotations\Signal
     */
    protected function emitAfterNodePublishing(\Neos\ContentRepository\Domain\Model\NodeInterface $node, \Neos\ContentRepository\Domain\Model\Workspace $targetWorkspace)
    {
        ...
        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitAfterNodePublishing'])) {
            ...
            try {
                ...
                $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\ContentRepository\Domain\Model\Workspace', 'emitAfterNodePublishing', $methodArguments);
                $result = $this->Flow_Aop_Proxy_invokeJoinPoint($joinPoint);
                $methodArguments = $joinPoint->getMethodArguments();

                if (isset($this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitAfterNodePublishing']['Neos\Flow\Aop\Advice\AfterReturningAdvice'])) {
                    $advices = $this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitAfterNodePublishing']['Neos\Flow\Aop\Advice\AfterReturningAdvice'];
                    $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\ContentRepository\Domain\Model\Workspace', 'emitAfterNodePublishing', $methodArguments, NULL, $result);
                    foreach ($advices as $advice) {
                        $advice->invoke($joinPoint);
                    }
  ...
  'rootNodeData' => 'Neos\\ContentRepository\\Domain\\Model\\NodeData',
  ...
  'persistenceManager' => 'Neos\\Flow\\Persistence\\PersistenceManagerInterface',
    ...
    private function Flow_Proxy_injectProperties()
    {
        ...
        $this->Flow_Proxy_LazyPropertyInjection('Neos\ContentRepository\Domain\Service\PublishingServiceInterface', 'Neos\Neos\Service\PublishingService', 'publishingService', 'ab03c17b627413e110e3919a4df42e99', function() { return \Neos\Flow\Core\Bootstrap::$staticObjectManager->get('Neos\ContentRepository\Domain\Service\PublishingServiceInterface'); });
...
# PathAndFilename: /var/www/html/neos/Packages/Application/Neos.ContentRepository/Classes/Domain/Model/Workspace.php
#