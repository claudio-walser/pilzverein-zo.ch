...
class MoveAfter_Original extends AbstractMove
{
    /**
 ...
 * 
 */
class MoveAfter extends MoveAfter_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if ('Neos\Neos\Ui\Domain\Model\Changes\MoveAfter' === get_class($this)) {
...
# PathAndFilename: /var/www/html/neos/Packages/Application/Neos.Neos.Ui/Classes/Domain/Model/Changes/MoveAfter.php
#