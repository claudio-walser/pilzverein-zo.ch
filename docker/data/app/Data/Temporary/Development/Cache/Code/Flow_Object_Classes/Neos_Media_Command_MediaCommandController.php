 ...
 */
class MediaCommandController extends MediaCommandController_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\Media\Command\MediaCommandController') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Media\Command\MediaCommandController', $this);
        parent::__construct();
        if ('Neos\Media\Command\MediaCommandController' === get_class($this)) {
  ...
  'mappingStrategy' => 'Neos\\Media\\Domain\\Strategy\\AssetModelMappingStrategyInterface',
  ...
  'output' => 'Neos\\Flow\\Cli\\ConsoleOutput',
    ...
    private function Flow_Proxy_injectProperties()
    {
        ...
        $this->entityManager = \Neos\Flow\Core\Bootstrap::$staticObjectManager->get('Doctrine\ORM\EntityManagerInterface');
        ...
        $this->Flow_Proxy_LazyPropertyInjection('Neos\Media\Domain\Strategy\AssetModelMappingStrategyInterface', 'Neos\Media\Domain\Strategy\ConfigurationAssetModelMappingStrategy', 'mappingStrategy', 'b23095604be2f63a7f617ee8f8cf92d5', function() { return \Neos\Flow\Core\Bootstrap::$staticObjectManager->get('Neos\Media\Domain\Strategy\AssetModelMappingStrategyInterface'); });
...
# PathAndFilename: /var/www/html/neos/Packages/Application/Neos.Media/Classes/Command/MediaCommandController.php
#