 ...
 */
class SettingsController_Original extends ActionController
{
    /**
     * @return string
     */
 ...
 */
class SettingsController extends SettingsController_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    public function __construct()
    {
        ...
        if (get_class($this) === 'Neos\Neos\Controller\Backend\SettingsController') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Neos\Controller\Backend\SettingsController', $this);
        if ('Neos\Neos\Controller\Backend\SettingsController' === get_class($this)) {
    ...
    public function editPreviewAction()
    {
        ...
        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['editPreviewAction'])) {
            ...
            try {
                ...
                $adviceChain->rewind();
                $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\Neos\Controller\Backend\SettingsController', 'editPreviewAction', $methodArguments, $adviceChain);
...
# PathAndFilename: /var/www/html/neos/Packages/Application/Neos.Neos/Classes/Controller/Backend/SettingsController.php
#