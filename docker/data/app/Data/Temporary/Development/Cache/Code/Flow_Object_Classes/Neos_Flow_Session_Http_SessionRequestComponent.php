 ...
 */
class SessionRequestComponent_Original implements ComponentInterface
{
    /**
 ...
 * A HTTP component that initialises the standard Flow session with cookie information.
 */
class SessionRequestComponent extends SessionRequestComponent_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if ('Neos\Flow\Session\Http\SessionRequestComponent' === get_class($this)) {
...
# PathAndFilename: /var/www/html/neos/Packages/Framework/Neos.Flow/Classes/Session/Http/SessionRequestComponent.php
#