...
class ImageHelper_Original implements ProtectedContextAwareInterface
{
    /**
     * @Flow\Inject
 ...
 * 
 */
class ImageHelper extends ImageHelper_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if ('Neos\Seo\Fusion\Helper\ImageHelper' === get_class($this)) {
...
# PathAndFilename: /var/www/html/neos/Packages/Application/Neos.Seo/Classes/Fusion/Helper/ImageHelper.php
#