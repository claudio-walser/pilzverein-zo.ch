 ...
 */
class PluginViewTransformation_Original extends AbstractTransformation
{
    /**
     * @Flow\Inject
 ...
 * Convert PluginViews references from node paths to identifiers
 */
class PluginViewTransformation extends PluginViewTransformation_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if ('Neos\Neos\TYPO3CR\Transformations\PluginViewTransformation' === get_class($this)) {
...
# PathAndFilename: /var/www/html/neos/Packages/Application/Neos.Neos/Classes/TYPO3CR/Transformations/PluginViewTransformation.php
#