 ...
 */
class VideoRepository_Original extends AssetRepository
{
}
 ...
 */
class VideoRepository extends VideoRepository_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\Media\Domain\Repository\VideoRepository') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Media\Domain\Repository\VideoRepository', $this);
        parent::__construct();
        if ('Neos\Media\Domain\Repository\VideoRepository' === get_class($this)) {
...
# PathAndFilename: /var/www/html/neos/Packages/Application/Neos.Media/Classes/Domain/Repository/VideoRepository.php
#