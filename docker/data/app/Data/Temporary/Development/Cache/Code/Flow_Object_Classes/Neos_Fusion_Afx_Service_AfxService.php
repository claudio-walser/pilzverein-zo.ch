 ...
 */
class AfxService extends AfxService_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\Fusion\Afx\Service\AfxService') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Fusion\Afx\Service\AfxService', $this);
    }
...
# PathAndFilename: /var/www/html/neos/Packages/Application/Neos.Fusion.Afx/Classes/Service/AfxService.php
#