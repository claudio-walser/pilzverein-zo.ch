...
class CacheFactory extends CacheFactory_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    public function __construct()
    {
        ...
        if (!array_key_exists(2, $arguments)) $arguments[2] = \Neos\Flow\Core\Bootstrap::$staticObjectManager->getSettingsByPath(explode('.', 'Neos.Flow.cache.applicationIdentifier'));
...
# PathAndFilename: /var/www/html/neos/Packages/Framework/Neos.Flow/Classes/Cache/CacheFactory.php
#