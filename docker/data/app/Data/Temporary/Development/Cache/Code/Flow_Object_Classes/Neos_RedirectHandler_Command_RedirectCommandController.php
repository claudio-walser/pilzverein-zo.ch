 ...
 */
class RedirectCommandController_Original extends CommandController
{
    /**
     * @Flow\Inject
 ...
 */
class RedirectCommandController extends RedirectCommandController_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\RedirectHandler\Command\RedirectCommandController') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\RedirectHandler\Command\RedirectCommandController', $this);
        parent::__construct();
        if ('Neos\RedirectHandler\Command\RedirectCommandController' === get_class($this)) {
...
# PathAndFilename: /var/www/html/neos/Packages/Application/Neos.RedirectHandler/Classes/Command/RedirectCommandController.php
#