...
class CopyBefore_Original extends AbstractCopy
{
    /**
 ...
 * 
 */
class CopyBefore extends CopyBefore_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if ('Neos\Neos\Ui\Domain\Model\Changes\CopyBefore' === get_class($this)) {
...
# PathAndFilename: /var/www/html/neos/Packages/Application/Neos.Neos.Ui/Classes/Domain/Model/Changes/CopyBefore.php
#