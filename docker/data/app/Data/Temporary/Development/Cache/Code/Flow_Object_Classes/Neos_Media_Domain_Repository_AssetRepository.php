 ...
 */
class AssetRepository_Original extends Repository
{
    /**
 ...
 */
class AssetRepository extends AssetRepository_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\Media\Domain\Repository\AssetRepository') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Media\Domain\Repository\AssetRepository', $this);
        parent::__construct();
        if ('Neos\Media\Domain\Repository\AssetRepository' === get_class($this)) {
...
# PathAndFilename: /var/www/html/neos/Packages/Application/Neos.Media/Classes/Domain/Repository/AssetRepository.php
#